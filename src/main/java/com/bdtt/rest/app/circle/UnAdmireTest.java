...
public class UnAdmireTest {
	
	String testUrl="Circle/unAdmire";
	...
	public Object[][] Parameter() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException{
    	return new Object[][]{
        	{uid, token, GetCircleFeedId.getCircleFeedId(0), "1", "success"},
        	{"", token, GetCircleFeedId.getCircleFeedId(0), "1", "success"},
        }; 
	}
	
	@BeforeClass
	public void setUp() throws UnsupportedEncodingException {
		System.out.println("点赞取消接口测试开始！");
	}
	
	@AfterClass
	public void tearDown() {
		System.out.println("点赞取消接口测试结束！");
	}
	
	@Test(dataProvider="ex")
	public void loginTest(String uid, String token, String feed_id, String excode, String exmsg) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException {	
