...
public class AddToIndexTest {
	
	String testUrl="circle/addToIndex";
	...
	public Object[][] Parameter() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException{
    	return new Object[][]{
        	...
        	{GetMySql.getUserId("13066666666"), GetCircleFeedId.getCircleFeedId(0), "10019", "无操作权限"},
        	{"", GetCircleFeedId.getCircleFeedId(0), "10019", "无操作权限"},
        }; 
	}
	
	@BeforeClass
	public void setUp() throws UnsupportedEncodingException {
		System.out.println("动态推荐到首页本地圈推广位接口测试开始！");
	}
	
	@AfterClass
	public void tearDown() {
		System.out.println("动态推荐到首页本地圈推广位接口测试结束！");
	}
	
	@Test(dataProvider="ex")
	public void addToIndexTest(String uid, String feed_id, String excode, String exmsg) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException {	
