 ...
 * 本脚本用于验证兴化-本地模式下，本地圈动态流每次上滑加载后不出现重复动态
 */

public class CircleLocalFeedRequestTest {
	...
	public String getLocalSquareFeeds() {
		
    	//String url = "http://app.benditoutiao.com/bdq/Circle/getLocalSquareFeeds?bdread=bendichengqun-henxin310000";
    	String url = "http://app.benditoutiao.com/bdq/Circle/getLocalSquareFeeds";
	...
	public static void main (String[] args) {
		...
		CircleLocalFeedRequestTest localfeedtest = new CircleLocalFeedRequestTest();

		for (int i=0; i<requesttimes; i++) {
			String dataresult = localfeedtest.getLocalSquareFeeds();
			List<String> feedlist1 = localfeedtest.getFeedList(dataresult);
