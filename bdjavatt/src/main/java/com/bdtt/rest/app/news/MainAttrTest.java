...
public class MainAttrTest {
	
	String testUrl="news/mainAttr";
	...
	public void setUp() throws UnsupportedEncodingException {
		System.out.println("新闻主要属性接口测试开始！");
	}
	
	@AfterClass
	public void tearDown() {
		System.out.println("新闻主要属性接口测试结束！");
	}
	
	@Test(dataProvider="ex")
	public void loginTest(String news_id, String excode, String exmsg) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException {	
