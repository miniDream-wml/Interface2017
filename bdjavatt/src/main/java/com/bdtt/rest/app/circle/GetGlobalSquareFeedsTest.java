...
public class GetGlobalSquareFeedsTest {
	
	String testUrl="circle/getGlobalSquareFeeds";
	...
	public void loginTest(String uid, String exposure_feeds, String circle_mode, String index, String mode, String excode, String exmsg) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, IOException {	
        ...
        params.put("uid", uid);
        params.put("exposure_feeds", exposure_feeds);
